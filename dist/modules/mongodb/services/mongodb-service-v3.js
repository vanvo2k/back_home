...
const mongodb_v3_1 = require("mongodb-v3");
...
class MongodbServiceV3 extends mongodb_service_abstraction_1.default {
    constructor() {
        super();
        this.driverVersion = mongodb_enum_1.MongodbDriverVersion.V3;
    }
    static getInstance() {
    ...
    createClient(configuration) {
        ...
        this._clients.set(configuration.alias, new mongodb_v3_1.MongoClient(configuration.uri, configuration.options));
...
MongodbServiceV3.instance = null;
exports.default = MongodbServiceV3;
//# sourceMappingURL=mongodb-service-v3.js.map