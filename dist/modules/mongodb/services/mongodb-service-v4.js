...
const mongodb_v4_1 = require("mongodb-v4");
...
class MongodbServiceV4 extends mongodb_service_abstraction_1.default {
    constructor() {
        super();
        this.driverVersion = mongodb_enum_1.MongodbDriverVersion.V4;
    }
    static getInstance() {
    ...
    createClient(configuration) {
        ...
        this._clients.set(configuration.alias, new mongodb_v4_1.MongoClient(configuration.uri, configuration.options));
...
MongodbServiceV4.instance = null;
exports.default = MongodbServiceV4;
//# sourceMappingURL=mongodb-service-v4.js.map